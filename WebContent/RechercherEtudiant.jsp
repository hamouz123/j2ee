...
<ul>
 ...
 <center>	<h2>Recherche des Etudiants</h2></center>

   <div class="container">
        <div class="row">
         
       <div class="col-sm-6">
         <form method="post" action="<%=request.getContextPath()%>/gestionEtd">
      	 	
		  	<input type="text" name="search" placeHolder="Taperz Id Etudiant" name="q">	
