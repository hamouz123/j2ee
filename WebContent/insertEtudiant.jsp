            ...
            <div class="table-title">
				...
				<form action="<%=request.getContextPath()%>/InsertEtudiant" method="post">
					<div class="modal-header">						
						...
						<h4 class="modal-title" name="validation"></h4>
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Moyenne</label>
							<input type="text" name="moyenne"class="form-control" required>
						</div>
						<div class="form-group">
							<label>Login</label>
					...
					<a href="insertEtudiant.jsp" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Annuler</span></a>						
